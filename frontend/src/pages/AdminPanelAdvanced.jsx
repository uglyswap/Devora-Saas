...
import { 
  ...
  Save, Plus, Minus, Ban, CheckCircle, Search
} from 'lucide-react';
...
const AdminPanelAdvanced = () => {
  ...
  const [activeTab, setActiveTab] = useState('info'); // info, projects, billing
  ...
  const revokeAdmin = async (userId) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(data.detail || 'Erreur lors de la révocation');
      }
    } catch (error) {
  ...
  const getTotalPaid = (user) => {
    // This would come from invoices in real implementation
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0b] via-[#111113] to-[#0a0a0b]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-2">Gestion complète des utilisateurs et de la plateforme</p>
        </div>
                    ...
                    <div>
                      ...
                      <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button className="flex-1 bg-red-500/20 text-red-400 hover:bg-red-500/30">
        ...
        {/* Configuration System (Collapsible) */}
        <details className="bg-white/5 border border-white/10 rounded-lg p-8 mt-8">
          <summary className="text-2xl font-bold text-white cursor-pointer">
              ...
              <div className="space-y-4">
                <div>
                  <label className="flex items-center">
                    ...
                    />
                    <span className="ml-2 text-sm text-gray-300">Mode Test</span>
                  </label>
                </div>
                <div>
